...
export default function ContactCTA() {
  ...
  return (
    <section id="kontakt" className="relative py-24 md:py-40 px-4 md:px-8 hairline-t bg-void-950">
      ...
      <div className="relative max-w-[1440px] mx-auto">
        <div className="grid md:grid-cols-[1fr_1.1fr] gap-10 md:gap-16 items-start">
          ...
          <div>
            ...
            <p className="mt-8 text-white/70 text-lg leading-snug max-w-md">
            ...
            <div className="mt-10 space-y-3">
              <a
                ...
                className="btn-press panel-hard border border-white/10 flex items-center justify-between px-5 py-4 hover:bg-white/5 transition-colors"
              >
                <span className="flex items-center gap-4">
                  <IconPhone />
                  <div className="flex flex-col leading-none gap-1">
                    <span className="vin text-white/50">Telefon</span>
                    <span className="d-hero text-white text-2xl tabular">
                      06831 704070
                    </span>
                  </div>
                </span>
              ...
              >
                <span className="flex items-center gap-4">
                  ...
                  <div className="flex flex-col leading-none gap-1">
                    ...
                    <span className="d-stencil text-white text-xl">
                      info@carundsound.de
                    </span>
                  </div>
                </span>
          ...
          >
            <div className="px-6 py-4 border-b border-white/10 bg-void-800/40 flex items-center justify-between">
            ...
            <div className="p-6 md:p-8 flex flex-col gap-5">
                ...
                <div className="flex flex-wrap gap-2">
                  {topics.map((t) => (
                    <button
                      ...
                      type="button"
                      onClick={() => setTopic(t)}
                      className={`btn-press text-xs px-3 py-1.5 border transition-all duration-200 uppercase tracking-widest font-stencil ${
                        topic === t
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-void-800 border border-white/10 px-4 py-3 text-white placeholder:text-white/30 focus:border-oxide-500 focus:outline-none transition-colors resize-none font-medium"
                />
              </div>

              <button
                type="submit"
                className="btn-press oxide-btn py-4 uppercase tracking-widest font-stencil text-base flex items-center justify-center gap-3"
              >
                Anfrage absenden
                <Arrow />
              </button>
  ...
  return (
    <div>
      ...
      <input
        ...
        required={required}
        className="w-full bg-void-800 border border-white/10 px-4 py-3 text-white placeholder:text-white/30 focus:border-oxide-500 focus:outline-none transition-colors font-medium"
      />
    </div>
  );
}
