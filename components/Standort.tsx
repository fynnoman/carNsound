...
export default function Standort() {
  ...
  return (
    <section id="standort" ref={ref} className="relative min-h-screen overflow-hidden hairline-t">
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-4 md:px-8 py-24 md:py-40">
        <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-start">
          ...
          <div>
            ...
            <p className="mt-8 text-white/80 text-lg leading-snug max-w-md">
            ...
            <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-3">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="btn-press panel-hard border border-white/10 p-5 flex flex-col hover:bg-white/5 transition-colors"
              >
                <span className="vin text-white/50 mb-2">Navigation</span>
                <span className="d-stencil text-white text-2xl">Route öffnen</span>
              ...
              <a
                ...
                className="btn-press oxide-btn p-5 flex flex-col"
              >
                <span className="mono text-[10px] text-white/80 mb-2 tracking-widest uppercase">
                  24/7 Anruf
                </span>
                <span className="d-hero text-white text-2xl tabular leading-none">
                  06831&nbsp;704070
                </span>
          ...
          >
            <div className="flex items-center justify-between px-6 py-4 border-b border-white/10 bg-void-800/40">
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-white/[0.06]">
                  <th className="text-left px-6 py-3 mono text-[10px] text-white/40 uppercase tracking-widest font-normal">Tag</th>
                  <th className="text-right px-6 py-3 mono text-[10px] text-white/40 uppercase tracking-widest font-normal">Vormittag</th>
                  <th className="text-right px-6 py-3 mono text-[10px] text-white/40 uppercase tracking-widest font-normal">Nachmittag</th>
                </tr>
              </thead>
              <tbody>
                {hours.map(([day, morning, afternoon], i) => {
                  ...
                  return (
                    ...
                    >
                      <td className={`px-6 py-4 d-stencil text-lg ${
                        isToday ? "text-oxide-300" : isClosed ? "text-white/35" : "text-white"
                      }`}>
                        <span className="flex items-center gap-2">
                          {isToday && <span className="w-1.5 h-1.5 rounded-full bg-oxide-400 animate-pulse" />}
                          {day}
                        </span>
                      </td>
                      <td className={`text-right px-6 py-4 mono text-sm tabular ${
            ...
            <div className="px-6 py-4 border-t border-white/10 flex items-center justify-between text-[11px]">
              <span className="mono text-white/50 tracking-widest uppercase">
                Notfall · nach Absprache
              </span>
              <span className="mono text-white/50 tabular">TZ: EUROPE/BERLIN</span>
            </div>
          </motion.div>
        </div>
        ...
        <motion.div
          ...
          viewport={{ once: true, margin: "-100px" }}
          transition={{ duration: 0.7, ease: [0.16, 1, 0.3, 1] }}
          className="mt-10 md:mt-16 panel-hard border border-white/10 relative overflow-hidden"
        >
          <div className="flex items-center justify-between px-6 py-4 border-b border-white/10 bg-void-800/40">
            <span className="tape-label">Anfahrt · Google Maps</span>
            <span className="mono text-[10px] text-white/50 tracking-widest tabular">
          ...
          <div className="flex items-center justify-between px-6 py-4 border-t border-white/10 gap-4 flex-wrap">
            <span className="d-stencil text-white text-lg leading-tight">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="btn-press oxide-btn inline-flex items-center gap-2 px-5 py-3 uppercase tracking-widest text-xs font-stencil"
            >
              Route berechnen
